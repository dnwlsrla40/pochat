...
//
//        // option 요청은 바로 통과 ??
//        if(req.getMethod().equals("OPTIONS") || req.getServletPath().equals("/thumbnail") || req.getServletPath().equals("/resource/2020/12/23/43f8e41c-2186-4e20-9179-b9322058ab24_KakaoTalk_20201115_183320402.png")) {
//            return true;
//        } else{
//            // req의 헤더에 token 찾기;
